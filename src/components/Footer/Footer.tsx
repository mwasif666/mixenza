                    ...
                    <div className="container">
                        <div className="content-footer py-[60px] flex justify-between flex-wrap gap-y-8">
                            <div className="company-infor basis-1/4 max-lg:basis-full pr-7">
                                ...
                                <div className='flex gap-3 mt-3'>
                                    ...
                                    <div className="flex flex-col ">
                                        <span className=''>{BRAND.email}</span>
                                        <span className='mt-3'>{BRAND.phone}</span>
                                        <span className='mt-3 pt-px'>{BRAND.address}</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="newsletter basis-1/3 pl-7 max-md:basis-full max-md:pl-0">
                                    ...
                                    <div className="input-block w-full h-[52px] mt-4">
                                        <form className='w-full h-full relative' action="post">
                                            ...
                                            <button className='w-[44px] h-[44px] bg-primary hover:bg-primary-dark duration-300 flex items-center justify-center rounded-xl absolute top-1 right-1'>
                        ...
                        <div className="footer-bottom py-3 flex items-center justify-between gap-5 max-lg:justify-center max-lg:flex-col border-t border-line">
                            <div className="left flex items-center gap-8">
                                <div className="copyright caption1 text-secondary">©{new Date().getFullYear()} {BRAND.name}. All Rights Reserved.</div>
