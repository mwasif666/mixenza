...
/**
 * The full Mixenza marketplace storefront.
 *
 * `/` currently serves the coming-soon holding page (src/app/page.tsx), so the
 * storefront lives here. To go live, point `/` back at this component:
 *   export { default } from '@/app/homepages/marketplace/page'
 */
